        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn deliver(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/faction.Transport/Deliver",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("faction.Transport", "Deliver"));
...
pub mod transport_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/faction.Transport/Deliver" => {
                    ...
                    struct DeliverSvc<T: Transport>(pub Arc<T>);
                    impl<T: Transport> tonic::server::UnaryService<super::Envelope>
                    for DeliverSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Transport>::deliver(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "faction.Transport";
    impl<T> tonic::server::NamedService for TransportServer<T> {
